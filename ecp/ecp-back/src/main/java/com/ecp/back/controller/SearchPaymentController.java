...
/**
	...
	* @ClassName:     SearchPaymentController.java
	* @Description:   回款查询
	* 
	* @author:        lenovo
	* @version:       V1.0  
	* @Date:          2018年4月1日 下午1:14:56 
*/
@Controller
@RequestMapping("/back/searchpay")
public class SearchPaymentController {
	private final Logger log = Logger.getLogger(getClass());
	
	private static final String RESPONSE_THYMELEAF_BACK = "back/thymeleaf/searchpay/";
