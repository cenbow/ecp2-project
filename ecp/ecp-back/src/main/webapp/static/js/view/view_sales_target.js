...
function selectDetails(id){
	resetFun();
	var url = "back/view/sales-target/select-update";
	var params = {"id":id};
...
function saveFun(){
	...
	if(id==null || id==""){
		url = "back/view/sales-target/insert";
	}else{
		url = "back/view/sales-target/update";
	}
...
function deleteInfoAjaxRequest(id){
	var url = "back/view/sales-target/delete";
	var params = {"id":id};
	//util.loading();
	$.post(url, params, function(res){
		console.log(res);
...
function reloadInfoFun(){
	//操作成功后重新加载
	var href = "back/view/sales-target/select-items?pagehelperFun=clickPageBtnRequestFun";
...
function clickPageBtnRequestFun(params){
	var action = "back/view/sales-target/select-items";
