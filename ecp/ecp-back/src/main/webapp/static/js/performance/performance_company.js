...
$(function() {
	...
	$(".look-performance-btn").on("click", function(e) {
		var url = BASE_CONTEXT_PATH + "/back/performance/company/get-account-company"; // 需要提交的 url
		...
		var accountType = 7;//业绩
		var title = "业绩列表";
		
		var params = {"orderId":id, "provinceName":provinceName, "cityName":cityName, "countyName":countyName, "accountType":accountType, "userId":userId,"roleId":roleId};
		loadPerformancePage(url, params, title);
	...
	$("#this-year-performance-btn").on("click", function(e) {
		...
		var params = {"fullYear":fullYear, "provinceName":provinceName, "cityName":cityName, "countyName":countyName, "accountType":accountType, "userId":userId,"roleId":roleId};
		loadPerformancePage(url, params, title);
	...
	$("#last-year-performance-btn").on("click", function(e) {
		...
		var params = {"fullYear":fullYear-1, "provinceName":provinceName, "cityName":cityName, "countyName":countyName, "accountType":accountType, "userId":userId,"roleId":roleId};
		loadPerformancePage(url, params, title);
	...
	$("#two-years-ago-performance-btn").on("click", function(e) {
		...
		var params = {"fullYear":fullYear-2, "provinceName":provinceName, "cityName":cityName, "countyName":countyName, "accountType":accountType, "userId":userId,"roleId":roleId};
		loadPerformancePage(url, params, title);
	 ...
	 * 【最低限价利润】按钮
	 */
	$("#lowest-price-profit-btn").on("click", function(e) {
		var url = BASE_CONTEXT_PATH + "/back/performance/company/get-account-company"; // 需要提交的 url
		var fullYear = getFullYear();
		//区域条件
		var provinceName=$("#provinceName").val();
	 ...
	 * 【硬成本价利润】按钮
	 */
	$("#hard-cost-price-profit-btn").on("click", function(e) {
		var url = BASE_CONTEXT_PATH + "/back/performance/company/get-account-company"; // 需要提交的 url
		var fullYear = getFullYear();
		//区域条件
		var provinceName=$("#provinceName").val();
	 ...
	 * @returns
	 */
	function loadPerformancePage(url, params, title){
		$("#edit-body-account-company").load(url, params, function(){
			$("#edit-tab-account-company").removeClass("hide");
			$("#tab-account-company-title").text(title);
