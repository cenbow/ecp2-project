...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
					...
					<div class="tabs-container" id="tabs-pushmoney-config">
						<ul class="nav nav-tabs" id="top_tab">
							...
							<li class="hide" id="edit-pushmoney-config-li"><a
								data-toggle="tab" href="#tab-pushmoney-config-edit" aria-expanded="false">详情</a></li>
						</ul>
		...
		<script type="text/javascript" src="static/js/view/view_pushmoney_config.js"></script>
</body>
</html>
