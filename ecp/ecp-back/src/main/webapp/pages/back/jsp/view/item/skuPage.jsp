...
<button type="button" class="btn btn-primary" id="edit-default-sku-spec-btn" onclick="javascript:openDefaultSpecModel(0);">默认sku规格</button>
<!-- sku规格对话框 -->
...
<button type="button" class="btn btn-primary" id="edit-default-sku-short-spec-btn" onclick="javascript:openDefaultShortSpecModel(0);">默认参数</button>
<!-- 简单sku规格对话框 -->
